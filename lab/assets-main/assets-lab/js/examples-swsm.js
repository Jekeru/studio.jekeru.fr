...
function showCode ($elem) {
	...
	if ($elem.is("section.demo")) {
		...
		var $desc = $("div#cinema-wrapper section#titlechart").clone();
...
$(document).ready(function () {
	...
	$("a.viewsource").each(function () {
		var
			...
			$relevantCode = $demoElements.length <= 1 ? $demoElements : $(this).parents(demoSelector + ", div#cinema-wrapper, body").first();
...
$(document).on("orientationchange", function (e) {
	if ($("#cinema-wrapper.horizontal").length > 0) {
